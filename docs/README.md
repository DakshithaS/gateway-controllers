...
| [OpenAI to Gemini Transformer](./openai-to-gemini-transformer/v0.9/docs/openai-to-gemini-transformer.md) | AI | Translates OpenAI Chat Completions requests into the Google Gemini generateContent API format and rewrites non-streaming Gemini responses back into the OpenAI response shape. |
