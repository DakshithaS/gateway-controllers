...
| [API Key Auth](./api-key-auth/v1.0/docs/apikey-authentication.md) | Security, AI, WebSub, WebBroker, WebSub | Implements API Key Authentication to protect APIs with pre-shared API keys. |
...
| [Basic Auth](./basic-auth/v1.0/docs/basic-auth.md) | Security, AI, WebSub, WebBroker, WebSub | Implements HTTP Basic Authentication to protect APIs with username and password credentials. |
...
| [JWT Auth](./jwt-auth/v1.0/docs/jwt-authentication.md) | Security, AI, WebSub, WebBroker, WebSub | Validates JWT access tokens using one or more JWKS providers (key managers). |
...
| [Log Message](./log-message/v1.0/docs/log-message.md) | Logging, Analytics & Monitoring, MCP, WebSub, WebBroker, WebSub | This policy provides the capability to log the payload and headers of a request/response. |
...
| [Remove Headers](./remove-headers/v1.0/docs/remove-headers.md) | Transformation, MCP, WebSub, WebBroker, WebSub | This policy provides the capability to remove headers from either the request or the response. |
...
| [Set Headers](./set-headers/v1.0/docs/set-headers.md) | Transformation, MCP, WebSub, WebBroker, WebSub | This policy provides the capability to set arbitrary headers to either the request or the response. |
