...
| [Granite Guardian Prompt Injection](./granite-guardian-prompt-injection/v1.0/docs/granite-guardian-prompt-injection.md) | Guardrails, AI | Detects prompt injection and jailbreak attempts in LLM API requests using IBM Granite Guardian 3.3 8B. |
