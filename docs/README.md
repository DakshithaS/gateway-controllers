...
| [OAuth2 Generator](./oauth2-generator/v0.1/docs/oauth2-generator.md) | Security, AI | Generates an upstream credential and injects it into a configurable request header before forwarding the request to the backend. |
