...
func (p *ContentLengthGuardrailPolicy) Mode() policyv1alpha2.ProcessingMode {
...
func (p *ContentLengthGuardrailPolicy) OnRequestBody(ctx *policyv1alpha2.RequestContext, _ map[string]interface{}) policyv1alpha2.RequestAction {
	...
	return p.validatePayload(ctx.Body.Content, p.requestParams, false).(policyv1alpha2.RequestAction)
}
...
// validatePayload validates payload content length, returning policyv1alpha2 actions.
